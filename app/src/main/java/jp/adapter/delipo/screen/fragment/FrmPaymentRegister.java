...
public class FrmPaymentRegister extends BaseFragment implements View.OnClickListener {

    public static FrmPaymentRegister getInstance() {
        return new FrmPaymentRegister();
    }

    public static FrmPaymentRegister getInstance(ArrayList<BackStackData> arrayList, HashMap<String, Object> mapData) {
        FrmPaymentRegister fragment = new FrmPaymentRegister();
    ...
    protected int getLayoutResId() {
        return R.layout.frm_payment_register;
    }

    @Override
    protected int getCurrentFragment() {
        return FRM_PAYMENT_REGISTER;
    }
    ...
    protected void loadControlsAndResize(View view) {
        ...
        View btnRating = view.findViewById(R.id.btnPaymentRegisRate);
        ...
        View btnRegistration = view.findViewById(R.id.btnRegistration);
        btnRegistration.getLayoutParams().width = activity.getSizeWithScale(100);
        btnRegistration.getLayoutParams().height = activity.getSizeWithScale(30);
...
//        btnMyPage.setOnClickListener(this);
    ...
    private void showPassBook() {
        try {
            ...
            activity.showPassBook(arrayList, null);
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
